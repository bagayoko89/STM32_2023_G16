...
/*void lcd_w1(I2C_HandleTypeDef* I2Cx, uint8_t value) // permet d'écrire sur le lcd
{
	I2C_HandleTypeDef* Handle = I2Cx;
	int i,j,k;
	i=value/10;
...
/*void lcd_p1(I2C_HandleTypeDef* I2Cx,uint8_t  value)
{
	I2C_HandleTypeDef* Handle = I2Cx;
    uint8_t v1,v2;
    int i;
    v1 = value%10;
    v2 = (value-v1)/10;
	    unsigned char data[2] = {0x40, 0x30|v1};
	    HAL_I2C_Master_Transmit(Handle,LCD_ADDRESS, (uint8_t *) data,2,1000);
